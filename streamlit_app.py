...
#image = Image.open('sadewadigitalnetwork.jpeg')
#image = Image.open('sadewagroup.jpeg')
...
with row1_1:
    ...
    st.markdown("<p style='color:blue; font-family:arial; font-style:strong; font-size:250%'>OF BM-STORE</p>", unsafe_allow_html=True)    
    ...
    #st.markdown("<p style='font-size:200%'><strong>Streamlit App by \
                #<a href='https://www.linkedin.com/pulse/visualisasi-data-dgn-streamlit-python-bosi-manurung'>Bosi Manurung</a></strong></p>", unsafe_allow_html=True)                
    st.markdown("<p style='font-size:200%'><strong>Streamlit App by \
                <a href='https://www.bosimanurung.net'>Bosi Manurung</a></strong></p>", unsafe_allow_html=True)                
    ...
    st.markdown("<p style='text-align:justify;'><strong><span style='font-size:105%'>\
                ...
                BM-STORE</span></strong> adalah sebuah \
                ...
                yang menetapkan tiga kriteria KPI-nya yakni Total Revenue, Best Seller Product \
                dan New Customer Growth (dalam jangka waktu bulan tertentu). Dengan mengukur \
